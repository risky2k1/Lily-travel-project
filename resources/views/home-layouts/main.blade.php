...
<!-- Modal -->
<div class="modal fade" id="booking_success_modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-success="{{session()->get('booking_success')}}">
